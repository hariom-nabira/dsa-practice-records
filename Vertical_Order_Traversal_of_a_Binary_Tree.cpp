// a MUCH better choice of data structure used than mine
// although this soln uses DFS, using map<int, multiset<int,int>> would be a better choice even with a BFS soln such as mine
